...
class MetricOptions:
    def __init__(self, G=None, G_kwargs={}, dataset_kwargs={}, num_gpus=1, rank=0, device=None, progress=None, cache=True, cache_path=None, verbose=False):
        ...
        self.progress       = progress.sub() if progress is not None and rank == 0 else ProgressMonitor(verbose=verbose)
        self.cache          = cache
